...
"[project]/src/actions/data:196b25 [app-ssr] (ecmascript) <text/javascript>": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$actions$2f$data$3a$196b25__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/src/actions/data:196b25 [app-ssr] (ecmascript) <text/javascript>");
"use client";
;
;
;
  ...
  `;
    ...
    const handleSendRequestEmail = async (vendorId)=>{
        ...
        if (vendor && vendor.w9Status === 'Not Requested') {
            ...
            const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$actions$2f$data$3a$196b25__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["sendMailAction"])(mailData);
            if (result.success) {
...
//# sourceMappingURL=src_b28111bd._.js.map